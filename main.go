...
func main() {
	...
	if err := godotenv.Load(); err != nil {
		log.Fatalf("error loading dotenv@")
	}
	...
	mux.HandleFunc("PUT /api/users", apiCfg.handlerUpdateEmailAndPW)
	mux.HandleFunc("GET /api/chirps", apiCfg.handlerGetAllChirpsByID)
